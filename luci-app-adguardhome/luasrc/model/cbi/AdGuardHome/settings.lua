...
---- service status
o = s:option(DummyValue, "status", translate("Service status"))
o.template = "AdGuardHome/service"
...
---- redirect status
o = s:option(DummyValue, "status", translate("Redirect status"))
o.template = "AdGuardHome/redirect"
o.value = translate("Collecting data...")
---- redirect
...
o.optional=true
---- wait net on boot
o = s:option(Flag, "waitonboot", translate("Waiting network on boot"))
o.default = 1
o.optional = true
